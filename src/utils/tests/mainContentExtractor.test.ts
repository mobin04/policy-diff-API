import { extractMainContent } from '../mainContentExtractor';
...
describe('mainContentExtractor', () => {
  ...
  it('should generate a deterministic fingerprint', () => {
    ...
    const result1 = extractMainContent(html);
    const result2 = extractMainContent(html);
  ...
  it('should change fingerprint if text length changes', () => {
    ...
    const result1 = extractMainContent(html1);
    const result2 = extractMainContent(html2);
