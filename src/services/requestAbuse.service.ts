...
/**
 * Event types for request abuse tracking
 */
export type AbuseEventType =
  | 'IDEMPOTENCY_REUSE'
  | 'IDEMPOTENCY_CONFLICT'
  | 'CROSS_KEY_IDEMPOTENCY_COLLISION'
  | 'JOB_POLLING'
  | 'HIGH_FREQUENCY_JOB_POLLING'
  | 'CLIENT_ERROR'
 ...
 */
export function trackJobPolling(apiKeyId: number, jobId: string): boolean {
 ...
 */
export function trackErrorRate(apiKeyId: number): boolean {
