...
exports.maskTemporalNoise = maskTemporalNoise;
 ...
 */
function isProtectedVersion(text, start, end) {
 ...
 */
function isNearAnchor(text, matchStart, matchEnd) {
 ...
 */
function maskTemporalNoise(input) {
    if (!input)
        return input;
    let result = input;
    const matches = [];
