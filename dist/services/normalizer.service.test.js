...
function runTests() {
    ...
    const out1 = (0, normalizer_service_1.normalizeContent)(tableSingle);
  ...
  `;
    const out2 = (0, normalizer_service_1.normalizeContent)(tableMulti);
    ...
    const out3 = (0, normalizer_service_1.normalizeContent)(listUnordered);
    assert(out3.includes('- Item 1') && out3.includes('- Item 2'), 'Unordered list failed');
    // 4. List ordered
    const listOrdered = '<ol><li>Step 1</li><li>Step 2</li></ol>';
    const out4 = (0, normalizer_service_1.normalizeContent)(listOrdered);
  ...
  `;
    const out5 = (0, normalizer_service_1.normalizeContent)(listNested);
    ...
    <ul><li>List</li></ul>
  `;
    const out6 = (0, normalizer_service_1.normalizeContent)(mixed);
