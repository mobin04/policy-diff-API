...
describe('Structural Normalization Tests', () => {
    ...
    test('should normalize single row table', () => {
        ...
        const out = (0, normalizer_service_1.normalizeContent)(tableSingle);
    ...
    `;
        const out = (0, normalizer_service_1.normalizeContent)(tableMulti);
        expect(out).toContain('| Plan | Price |');
    ...
    test('should normalize unordered list', () => {
        ...
        const out = (0, normalizer_service_1.normalizeContent)(listUnordered);
    ...
    test('should normalize ordered list', () => {
        ...
        const out = (0, normalizer_service_1.normalizeContent)(listOrdered);
    ...
    `;
        const out = (0, normalizer_service_1.normalizeContent)(listNested);
    ...
    test('should normalize mixed content (table + list)', () => {
      ...
      <ul><li>List</li></ul>
    `;
        const out = (0, normalizer_service_1.normalizeContent)(mixed);
    ...
    test('should handle empty table and list', () => {
        ...
        const out = (0, normalizer_service_1.normalizeContent)(empty);
        expect(out).toBe('');
    });
    ...
    `;
        const out = (0, normalizer_service_1.normalizeContent)(deep);
    ...
    test('should normalize non-standard whitespace', () => {
        ...
        const out = (0, normalizer_service_1.normalizeContent)(nonStd);
    ...
    test('should remove script and style tags', () => {
      ...
      <p>Clean Content</p>
    `;
        const out = (0, normalizer_service_1.normalizeContent)(dirty);
