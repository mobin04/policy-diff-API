...
exports.monitorRoutes = monitorRoutes;
const monitor_controller_1 = require("../controllers/monitor.controller");
const monitorBatch_controller_1 = require("../controllers/monitorBatch.controller");
/**
...
async function monitorRoutes(fastify) {
     ...
     */
    fastify.post('/monitor', monitor_controller_1.createMonitorJobController);
    /**
    ...
    }, monitorBatch_controller_1.createMonitorBatchController);
    /**
     * GET /v1/jobs/:jobId
     *
     ...
     * - 404: Job not found
     */
    fastify.get('/jobs/:jobId', monitor_controller_1.getJobStatusController);
}
